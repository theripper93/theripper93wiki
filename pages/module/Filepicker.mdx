Filepicker but better ![Filepicker+ Window](Fppwindow.png
"Filepicker+ Window")
...
![Favourites List](Fppfavlist.png "Favourites List")
...
are enabled in the Module settings ![Sidebar Picker](Sidebarpicker.png
"Sidebar Picker")
