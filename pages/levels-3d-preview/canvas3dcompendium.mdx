...
## Token Browser
    ...
    <Image
      src="/images/3D-Canvas/tokenbrowser.png"
      alt="Token Browser Interface"
      className={styles.wikiImage}
    />

If you have the [3D Canvas Token Collection](./canvas3dtokencompendium) installed you will have access to the Token Browser.
