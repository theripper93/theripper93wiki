...
Manifest URL: 
```txt copy
https://github.com/theripper93/canvas3dtokencompendium/releases/latest/download/module.json
```
...
Forge: `assets/canvas3dtokencompendium/miniatures` (Bazaar Tab)

Self Hosted: `modules/canvas3dtokencompendium/miniatures`
