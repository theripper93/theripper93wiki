...
On Scenes imported from the `Community Maps` this option will be disabled by default from the scene setting due to the potential danger of running custom code. If you trust the map creator you can enable it from the scene settings.
</Callout>
