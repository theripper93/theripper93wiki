...
Community Maps is a new 3D Canvas feature that lets you share and access maps made by the community directly in Foundry
...
From here you can search for maps by name, description or packs and download them by clicking the `Cloud` button located on the top left of the map cards.
