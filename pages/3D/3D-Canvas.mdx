...
To access the material browser simply click the circular icon left of the [Filepicker+](Filepicker) icon (<FontAwesomeIcon icon={faFileImport} />). [Material Browser Icon.png 958x958px](Material_Browser_Icon.pngnone)
