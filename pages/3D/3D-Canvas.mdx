...
[File3D Canvas Module Settings.pngthumb](File3D_Canvas_Module_Settings.pngthumb 'wikilink')
...
[FileGlobal 3D Canvas Settings.pngthumb](FileGlobal_3D_Canvas_Settings.pngthumb 'wikilink')
...
[File3D Canvas Scene Settings.pngthumb](File3D_Canvas_Scene_Settings.pngthumb 'wikilink') The
...
Allow players to open the 3D View by clicking the 3D Mode button <FontAwesomeIcon icon={faCube} />
...
the [MDN Page](https://developer.mozilla.org/en-US/docs/WebCSSfilter) on CSS Filter for more information.
...
[Levels](Levels 'Levels') module. Background tiles are rendered but
...
FIXME: Photo
[FileCreating Lights Video.webmthumb](FileCreating_Lights_Video.webmthumb 'wikilink') To
create a light, simply go to the light layer and drag to create a light,
all the standard foundry interactions are the same.

#### Particle Effects

TODO: Missing link for Particle Effects
You can enable Particle Effect emission on Lights in the 3D Tab, if you
want more information on what every option does, check the Particle Effects wiki page!
...
space will explore the full vertical space of that location. There are no current plans for 'true' 3D fog exploration because of performance costs.
...
Click it to open the available animations. Clicking on an animation will play the animation for all clients. Some animations might not work if the token is _Prone_ or _Defeated_.
...
are a good starting point for understanding the system and creating your own custom effects.
...
start can be provided. start and end can also be arrays of colors (e.g `.color(\[color1,color2\],\[color3,color4\]`).
...
To access the material browser simply click the circular icon left of the [Filepicker+](Filepicker) icon (<FontAwesomeIcon icon={faFileImport} />). [FileMaterial Browser Icon.pngnonethumb958x958px](FileMaterial_Browser_Icon.pngnonethumb958x958px 'wikilink')
...
> `Wood077_1K_AmbientOcclusion.jpg` > `Wood077_1K_Color.jpg` > `Wood077_1K_Emissive.jpg` > `Wood077_1K_Metalness.jpg` > `Wood077_1K_NormalGL.jpg` > `Wood077_1K_Roughness.jpg`
...
You need to select one of the files in the image field to use them in 3D Canvas. **For the full material to be loaded you can pick any of the
...
- [https://www.patreon.com/baileywiki Baileywiki] has dadvastdcollectiondofd3DdPrefabs,dHeightmaps,danddMapsdwithdheavydusedofdbuiltdindtoolsdfromdthedMapmakingdPack.  
  [https://www.patreon.com/Swift Swift
- Cartography] hasd3DdModelsdofdcompletedmapsdanddProps.
...
[httpsquaternius.comindex.htmldQuaternius]dhasdadlotdofdgreatdmodels,drequiredconversiondtodgltfdnowikihttpsquaternius.comindex.htmlnowiki  
 [httpswww.shapeways.comshopsdmworkshopdShapeways]dhasdfreedminiaturesd(accountdrequired).dOnlydthed3DdPrintingdmodelsdaredpaiddmaterials.  
 [httpsyoutu.be2UwQ5v1uQy0dHowdtodconvertdSTLs]

#### HDRIs

[httpspolyhaven.comhdrisdPolyhaven]  
 [httpswww.ihdri.comhdri-skies-outdoordiHDRI]  
 [httpshdrmaps.comdHDRMaps]  
 [httpslocationtextures.companoramasdLocationdTextures]

#### Skyboxes

[httpsopengameart.orgcontentskiingpenguins-skybox-packdSkyboxesdbydZacheryd“skiingpenguins”dSlocum]
...
[httpsproducts.aspose.app3dconversionfbx-to-gltfdModeldConverter]  
 [httpsthreejs.orgeditordModeldEditor]

#### Other

[httpssketchfab.comdSketchfab]dhasdtonsdofdfreed3Ddassetsdthatdyoudcanddownloaddalreadydindthedcorrectdformat
...
[httpsfoundryvtt.compackageslib-wrapperdLibdWrapper]dLibrarydmoduledfordmultidmoduledinteraction  
 [httpsfoundryvtt.compackagessocketlibdSocketlib]dLibrarydmoduledfordsendingdcommandsdbetweendclients  
[ Wall Height ](Wall_Height 'wikilink') Todhandledwalldsize  
[ Better Roofs ](Better_Roofs 'wikilink') FordtiledlogicdanddfordLevelsdtodfunction  
[ Levels ](Levels 'wikilink') Todhandled3Ddvisiondanddotherd3Ddlogic
...
[httpsgithub.comironmonk88monks-active-tilesdMonk'sdActivedTiledTriggers]d3DdCanvasdsupportsdMATTdclickdandddoubledclickdeventsdondtiles.
...
[httpsgithub.comtheripper93canvas3dcompendiumd3DdCanvasdCompendium]dHighlydRecommended.dContainsdassetsdthatdyoudcandusedind3DdCanvas,dsuchdasd3DdTiles,dSkyboxes,dHDRIsdanddMiniatures.  
[httpsgithub.comtheripper93canvas3dtokencompendiumd3DdCanvasdTokendCollection]dHighlydRecommended.ddAdcollectiondwithd1000+dHerodtokensdanddeverydDnD5edcreaturedanddmore.  
[ 3D Portraits ](3D_Portraits 'wikilink')Withdthisdmoduledyoudcandhaved3DdPortraitsdondyour sheets, Import HeroForge miniatures both in portraits and as tokens on the board and enable 3D Models previews in the filepicker (if you have[Filepicker+](Filepicker+ 'wikilink')).  
...
#### [Importing Maps from Townscaper by Chryron](TownscaperImporting_Maps_from_Townscaper_by_Chryron#3457 'wikilink')
