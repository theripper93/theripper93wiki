...
Controls {{\#fasuser}} and click the **Set Elevation for next placed
Template** button {{\#fassort}}. In the **Special** field, set the
...
the Filepicker+ icon ({{\#fasfile-import}}). [FileMaterial Browser
