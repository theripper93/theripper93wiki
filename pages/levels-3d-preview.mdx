...
Fog of war works slightly differently in 3D, with the default settings the map will be completely revealed. If you want to know more about how Fog of War works in 3D and it's performance implications and limitations, check the [Fog of War](levels-3d-preview/entities/fow) page.
