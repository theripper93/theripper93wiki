...
<Callout type='info' emoji='ℹ️'>
  The new Community Maps feature just launched! [Learn More](levels-3d-preview/communitymaps)
</Callout>
...
<ImageButBetter
  src="https://user-images.githubusercontent.com/1346839/168579424-7dd2436b-7503-46f4-8ea5-ff9a0925d610.png"
  alt="Automated Animations UI"
  className={styles.wikiimage}
/>
...
You can find the full documentation in the [Particle Scripting Wiki Page](./levels-3d-preview/particles)
