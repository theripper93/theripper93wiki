...
#### Using the Cauldron
To use the Cauldron, simply drop two or more items in the Cauldron window and click the `Mix Ingredients` button. Depending on how close you are to a recipe match, you will get a different result.
