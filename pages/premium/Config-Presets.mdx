...
## How to use
<Image src="/../public/images/Config-Presets/Cpopen.png" alt="Config Presets button" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Config-Presets/Cpwindow.png" alt="Config Presets Window" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Config-Presets/Cppresetedit.png" alt="Editing a Preset" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Config-Presets/Cpselectpreset.png" alt="Selecting a Preset" width={2000} height={2000} className={styles.wikiimage}/>
