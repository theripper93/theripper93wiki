...
infinite macros\! ![Macro Wheel in action](Macrowheel.png
"Macro Wheel in action")
...
![A sample setup of folders and subfolders](Macrowheelsample.png
"A sample setup of folders and subfolders") If `Use Root Folder` is
