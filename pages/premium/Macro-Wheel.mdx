...
## Getting Started
<<<<<<< HEAD
<ImageButBetter src="/public/images/Macro-Wheel/Macrowheel.png" alt="Macro Wheel in action" width={2000} height={2000} className={styles.wikiimage}/>
=======
<ImageButBetter src="/images/Macro-Wheel/Macrowheel.png" alt="Macro Wheel in action" width={2000} height={2000} className={styles.wikiimage}/>
...
<<<<<<< HEAD
<ImageButBetter src="/public/images/Macro-Wheel/Macrowheelsample.png" alt="A sample setup of folders and subfolders" width={2000} height={2000} className={styles.wikiimage}/>
=======
<ImageButBetter src="/images/Macro-Wheel/Macrowheelsample.png" alt="A sample setup of folders and subfolders" width={2000} height={2000} className={styles.wikiimage}/>
>>>>>>> parent of 08ecb10 (Relinking images)
