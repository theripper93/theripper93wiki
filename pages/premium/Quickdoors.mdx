...
<Image src="/../public/images/Quickdoors/Qdsize.png" alt="Doors Size Prompt" width={2000} height={2000} className={styles.wikiimage}/>
<Image src="/../public/images/Quickdoors/Qdbtn.png" alt="Quick Doors Toggle Button" width={2000} height={2000} className={styles.wikiimage}/>
