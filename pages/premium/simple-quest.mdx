...
<Image src='/images/simple-quest/simple-quest.png' alt='Simple Quest Interface' className={styles.wikiImage} />
...
<Image src='/images/simple-quest/simple-quest-map.png' alt='Simple Quest Map Tab' className={styles.wikiImage} />
...
Simple Quest supports the use of the [Mermaid](https://mermaid-js.github.io/mermaid/#/) library to create mindmaps and charts in your journal pages.
If you wish to learn this markdown style charting system, you can find the documentation on the website and use the [Live Editor](https://mermaid.live/) to test your charts.
You can also use the [Visual Editor](https://www.mermaidchart.com/)
...
Where `counterId` is a unique identifier for the counter, `maxValue` is the maximum value the counter can reach, `color` is the color of the counter and `icon` is the font awesome icon to use.
...
<Image src='/images/simple-quest/simple-quest-callouts.png' alt='Simple Quest Callouts' className={styles.wikiImage} />
