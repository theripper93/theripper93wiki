...
## Features
<Image src="/../public/images/Filepicker/Fppwindow.png" alt="Filepicker+ Window" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Filepicker/Fppapply.png" alt="Apply Button" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Filepicker/Fppaddfav.png" alt="Add Favourite Button" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Filepicker/Fppfavlist.png" alt="Favourites List" width={2000} height={2000} className={styles.wikiimage}/>
...
## Sidebar Picker
<Image src="/../public/images/Filepicker/Sidebarpicker.png" alt="Sidebar Picker" width={2000} height={2000} className={styles.wikiimage}/>
