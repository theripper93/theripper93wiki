...
## How to use
<Image src="/../public/images/Quickdraw/Quickdraw.png" alt="Quickdraw in action" width={2000} height={2000} className={styles.wikiimage}/>
...
## Configuration
<Image src="/../public/images/Quickdraw/Qdsett.png" alt="Quickdraw Settings" width={2000} height={2000} className={styles.wikiimage}/>
