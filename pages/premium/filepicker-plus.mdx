...
<ImageButBetter src="/images/Filepicker/Fppwindow.png" alt="Filepicker+ Window" width={2000} height={2000} className={styles.wikiimage}/>
...
- **Audio Previews:** Hovering an audio file will play it, you can
  ...
  feature)
- **3D Previews:** If you have [3D Portraits](../levels-3d-preview/three-actor-portrait)
  installed, Filepicker+ will preview 3D glb\\gltf files the same way
  as images.

<ImageButBetter src="/images/Filepicker/Fppapply.png" alt="Apply Button" width={2000} height={2000} className={styles.wikiimage}/>
...
<ImageButBetter src="/images/Filepicker/Fppaddfav.png" alt="Add Favourite Button" width={2000} height={2000} className={styles.wikiimage}/>
...
<ImageButBetter src="/images/Filepicker/Fppfavlist.png" alt="Favourites List" width={2000} height={2000} className={styles.wikiimage}/>
...
<ImageButBetter src="/images/Filepicker/Sidebarpicker.png" alt="Sidebar Picker" width={2000} height={2000} className={styles.wikiimage}/>
