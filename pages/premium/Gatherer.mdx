...
![Gatherer Sheet in View Mode](Gatherersview.png 'Gatherer Sheet in View Mode') Gatherer works with `Roll Tables`, so
...
`Fishing Rod,Bait` ![Gatherer Minigame](Gathererminigame.png 'Gatherer Minigame')
