...
=======
<ImageButBetter src="/images/Gatherer/Gatherertale.png" alt="Example Table" width={2000} height={2000} className={styles.wikiimage}/>
...
=======
<ImageButBetter src="/images/Gatherer/Gatherersheetselect.png" alt="Selecting the Gatherer Sheet" width={2000} height={2000} className={styles.wikiimage}/>
>>>>>>> parent of 08ecb10 (Relinking images)
...
=======
<ImageButBetter src="/images/Gatherer/Gatherersheetfilled.png" alt="A Fully setup Gatherer Sheet" width={2000} height={2000} className={styles.wikiimage}/>
>>>>>>> parent of 08ecb10 (Relinking images)
...
=======
  look like this when in view mode `Gatherer Sheet in View Mode` <ImageButBetter src="/images/Gatherer/Gatherersview.png" alt="Gatherer Sheet in View Mode" width={2000} height={2000} className={styles.wikiimage}/>
>>>>>>> parent of 08ecb10 (Relinking images)
...
=======
<ImageButBetter src="/images/Gatherer/Gathererminigame.png" alt="Gatherer Minigame" width={2000} height={2000} className={styles.wikiimage}/>
>>>>>>> parent of 08ecb10 (Relinking images)
