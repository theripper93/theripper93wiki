...
## Recommended Modules
<Image src="/../public/images/Gatherer/Gatherertale.png" alt="Example Table" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Gatherer/Gatherersheetselect.png" alt="Selecting the Gatherer Sheet" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Gatherer/Gatherersheetfilled.png" alt="A Fully setup Gatherer Sheet" width={2000} height={2000} className={styles.wikiimage}/>
...
- Once you saved and refreshed (if needed) your Journal Page should
  look like this when in view mode `Gatherer Sheet in View Mode` <Image src="/../public/images/Gatherer/Gatherersview.png" alt="Gatherer Sheet in View Mode" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Gatherer/Gathererminigame.png" alt="Gatherer Minigame" width={2000} height={2000} className={styles.wikiimage}/>
