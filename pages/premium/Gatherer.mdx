![Example Table](Gatherertale.png "Example Table")
...
![Selecting the Gatherer Sheet](Gatherersheetselect.png
"Selecting the Gatherer Sheet") ![A Fully setup Gatherer
Sheet](Gatherersheetfilled.png "A Fully setup Gatherer Sheet")
![Gatherer Sheet in View Mode](Gatherersview.png
"Gatherer Sheet in View Mode") Gatherer works with `Roll Tables`, so
...
`Fishing Rod,Bait` ![Gatherer Minigame](Gathererminigame.png
"Gatherer Minigame")
