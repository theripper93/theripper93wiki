...
<Image src="/../public/images/Token-Notes/Tnhudbtn.png" alt="Token Notes button in the Token HUD" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Token-Notes/Tnwindow.png" alt="Token Notes window in the top right position" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Token-Notes/Tnedit.png" alt="Token Notes Edit mode" width={2000} height={2000} className={styles.wikiimagesmall}/>
<Image src="/../public/images/Token-Notes/Tnnumbers.png" alt="Number turned into a counter" width={2000} height={2000} className={styles.wikiimagesmall}/>
