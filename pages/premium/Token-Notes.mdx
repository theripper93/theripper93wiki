...
![Token Notes button in the Token HUD](Tnhudbtn.png
"Token Notes button in the Token HUD")
...
![Token Notes window in the top right position](Tnwindow.png
"Token Notes window in the top right position") When opened, the Token
...
Edit mode](Tnedit.png "Token Notes Edit mode") Click the `Edit` button
to edit the notes.
...
![Number turned into a counter](Tnnumbers.png
"Number turned into a counter") If you type any number in the notes, it
