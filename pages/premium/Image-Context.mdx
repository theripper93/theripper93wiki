...
<Image src="/../public/images/Image-Context/Icmenu.png" alt="Image Context Menu" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Image-Context/Icbutton.png" alt="Image Context Scene controls button" width={2000} height={2000} className={styles.wikiimage}/>
