...
<Callout type='warning' emoji='⚠️'>
    The client requires a secure connection (https) to work. If you are hosting your game on a local network, you can use a service like ngrok to create a secure tunnel to your game. In the same way, self signed certificates will not work.
</Callout>
