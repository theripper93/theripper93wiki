...
### Creating a Tracker
<ImageButBetter src="/public/images/Progress-Tracker/Ptbuttons.png" alt="Progress
...
<ImageButBetter src="/public/images/Progress-Tracker/Ptmainwindow.png" alt="Main Window" width={2000} height={2000} className={styles.wikiimage}/>
