...
### Creating a Tracker
<Image src="/../public/images/Progress-Tracker/Ptbuttons.png" alt="Progress
...
<Image src="/../public/images/Progress-Tracker/Ptmainwindow.png" alt="Main Window" width={2000} height={2000} className={styles.wikiimage}/>
