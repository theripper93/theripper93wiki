...
<Image src="/../public/images/Situational-Shortcuts/Sssettings.png" alt="Module Settings" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Situational-Shortcuts/Ssconfigbon.png" alt="Configure Bonuses window" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Situational-Shortcuts/Ssroll.png" alt="Roll Prompt" width={2000} height={2000} className={styles.wikiimage}/>
