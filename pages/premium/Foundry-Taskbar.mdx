...
<Image src="/../public/images/Foundry-Taskbar/Taskbarmain.png" alt="Taskbar Interface" width={2000} height={2000} className={styles.wikiimage}/>
...
minimized windows.
<Image src="/../public/images/Foundry-Taskbar/Tbmini.png" alt="Minimize Button" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Foundry-Taskbar/Tssmalltime.png" alt="SmallTime Integration" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Foundry-Taskbar/Tbquickinserts.png" alt="Quick Inserts Integration" width={2000} height={2000} className={styles.wikiimage}/>
