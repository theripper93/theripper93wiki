...
It's worth noting that attempting to hide the video using CSS would not fully resolve the issue as the audio would still be audible, rendering it an inadequate solution.
