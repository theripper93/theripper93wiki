...
<Image src="/../public/images/Mastercrafted/Recipemanagerbtn.png" alt="The Recipe Manager button located in the Items Sidebar Tab" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Mastercrafted/Mastercraftedwindowedit.png" alt="The Main Mastercrafted Window" width={2000} height={2000} className={styles.wikiimage}/>
<Image src="/../public/images/Mastercrafted/Recipeedit.png" alt="The Recipe panel in Edit Mode" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Mastercrafted/Craftingbutton.png" alt="Crafting Button in the Actor Sheet header" width={2000} height={2000} className={styles.wikiimage}/>
...
<Image src="/../public/images/Mastercrafted/craftwindownoitem.png" alt="The crafting window. Ingredients are Red since the Actor does not own
them." width={2000} height={2000} className={styles.wikiimage}/>
