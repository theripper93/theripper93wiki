...
<ImageButBetter
  ...
  alt='The Recipe Manager button located in the Items Sidebar Tab'
  width={2000}
  height={2000}
...
<ImageButBetter
  ...
  alt='Crafting Button in the Actor Sheet header'
  width={2000}
  height={2000}
  className={styles.wikiimage}
/>
...
<ImageButBetter
  ...
  alt='The crafting window. Ingredients are Red since the Actor does not own
them.'
  width={2000}
  height={2000}
  className={styles.wikiimage}
