...
<Image src="/../public/images/Hover-Distance/Hdsingle.png" alt="Hovering a single token" width={2000} height={2000} className={styles.wikiimage}/>
# Hover Distance
...
<Image src="/../public/images/Hover-Distance/Hdmasshighlight.png" alt="Holding ALT to highlight all tokens" width={2000} height={2000} className={styles.wikiimage}/>
