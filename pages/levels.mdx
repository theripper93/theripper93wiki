...
1. Import all the levels of the map as separate scenes. For this example, we will assume you have the following levels, but it will work the same way for any number of levels:
  - Ground Floor
  - First Floor
  - Second Floor
...
9. You should now have all the levels imported into the Levels UI. You can delete the per-floor scenes now.
