...
If you used the Setup to install the client, you can find the `config.json` file in the `C:\Users\%your_user_name%\AppData\Local\vtt_player_client\app-%version%` folder.
</Callout>
