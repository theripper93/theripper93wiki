...
- Can I reposition the Carousel?
  - No, the Carousel is always docked to the top side of the screen.

- I don't see the Tracked Resource Bar on the Portrait, why?
  - The Tracked Resource Bar is only visible if you have set a Tracked Resource. Open the Combat Tracker Settings with the Cog icon and set a Tracked Resource.
