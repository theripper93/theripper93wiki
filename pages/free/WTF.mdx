...
import { imgCss } from '/../helpers/styles.js'

# What the Flag

Tooltips that indicate which module is adding which option.

<Image src="/../public/images/WTF/Wtftooltip.png" alt="Basic WTF Tooltip" width={2000} height={2000} style={{width: '100%',  height:'unset' }}/>
