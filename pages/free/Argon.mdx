...
<Image
  src='/../public/images/Argon/Argon_main_hud.png'
  alt='Argon Main HUD'
  width={2000}
  height={2000}
...
### Opening the HUD
<Image
  src='/../public/images/Argon/Hudspells.png'
  alt='The Spells HUD'
  width={2000}
  height={2000}
  className={styles.wikiimagesmall}
...
<Image
  src='/../public/images/Argon/Argonactiontracking.png'
  alt='Action Tracking'
  width={2000}
  height={2000}
  className={styles.wikiimagesmall}
...
### Action Tracking
<Image
  src='/../public/images/Argon/Weapon_Sets.png'
...
<Image
  src='/../public/images/Argon/Argontooltips.png'
  alt='Tooltips'
  width={2000}
  height={2000}
  className={styles.wikiimagesmall}
