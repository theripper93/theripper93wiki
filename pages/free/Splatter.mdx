...
token](/public/image/Splatter/Splatterbloodsheet.png) ![Data
Path settings](/public/image/Splatter/Splatterdatapath.png )
...
<Callout type="warning" emoji="⚠️">
  On some systems the **Creature Type** and **Custom Creature Type** options might cause Splatter to not work correctly
</Callout>

To fix this, imply go into the module
...
I know that this implementation doesen't have all the features BnG had but it has enough customization for most. 

**No feature requests will be implemented** because the point of this module is to keep it streamlined to avoid making it impossible to mantain. Unless it is something that all the users of this module would greatly benefit from. 
