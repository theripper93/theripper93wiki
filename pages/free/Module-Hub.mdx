...
<Image  src='/../public/images/Module-Hub/Phnotif.png'  alt='The Module Hub allerting you of a critical update'  width={2000}  height={2000}  className={styles.wikiimage}/>
...
<Image  src='/../public/images/Module-Hub/Phsettings.png'  alt='The Module Hub Settings'  width={2000}  height={2000}  className={styles.wikiimage}/>
...
## Documentation
<Image  src='/../public/images/Module-Hub/Hubdocs.png'  alt='Documentation Button'  width={2000}  height={2000}  className={styles.wikiimagesmall}/>
