...
<Image  src='/../public/images/Patrol/Patrolmulti.gif'  alt='Multi Path Patrol'  width={2000}  height={2000}  className={styles.wikiimage}/>
...
<Image  src='/../public/images/Patrol/Single_Path_Patrol.gif'  alt='Single Path Patrol'  width={2000}  height={2000}  className={styles.wikiimage}/>
...
<Image  src='/../public/images/Patrol/Patrol_Toggle.png'  alt='Patrol Toggle'  width={2000}  height={2000}  className={styles.wikiimage}/>
...
<Image  src='/../public/images/Patrol/Patrol_Token_Config.png'  alt='Patrol Token Config'  width={2000}  height={2000}  className={styles.wikiimage}/>
