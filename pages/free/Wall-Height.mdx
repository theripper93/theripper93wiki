...
![The scene setting for Wall Height](Scene_Config_Wall_Height.png
"The scene setting for Wall Height") `Enable Wall Height for Scene` in
...
![Token\_Height\_Adjustment.gif](Token_Height_Adjustment.gif
"Token_Height_Adjustment.gif") Tokens are able to see over walls which
...
![Token height input in token settings](Token_Height_Setting.png
"Token height input in token settings") The height of a token, which is
...
![The wall configuration menu](Wall_Config_Menu.png
"The wall configuration menu") Walls can be assigned a top elevation and
...
![The wall height tooltip](Wall_Height_Tooltip.png
"The wall height tooltip") The tooltip will display when a wall is
hovered, showing its lowest and highest elevation.

### Display Height on Walls

![Display Height on Walls|115x115px](Wall_Height_Display_Value.png
"Display Height on Walls|115x115px") While enabled, displays the
...
[Category:Free](Category:Free "wikilink")
