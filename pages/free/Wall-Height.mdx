...
### Tokens
<Image
  src='/../public/images/Wall-Height/Token_Height_Adjustment.gif'
  alt='Token Height Adjustment Menu'
  width={2000}
  height={2000}
  className={styles.wikiimage}
/>
Tokens are able to see over walls which
...
#### Token Height
<Image
  src='/../public/images/Wall-Height/Token_Height_Setting.png'
  alt='Token height input in token settings'
  width={2000}
  height={2000}
  className={styles.wikiimage}
/>
The height of a token, which is
...
If you are using the [Levels](../levels/Levels) module, remember that if the height of a token pushes it's head through a ceiling, you will see the floor above you!
</Callout>

### Walls
<Image
  src='/../public/images/Wall-Height/Wall_Config_Menu.png'
  alt='The wall configuration menu'
  width={2000}
  height={2000}
  className={styles.wikiimage}
/>
Walls can be assigned a top elevation and
...
## Settings
<Image
  src='/../public/images/Wall-Height/Scene_Config_Wall_Height.png'
  alt='The scene setting for Wall Height'
  width={2000}
  height={2000}
  className={styles.wikiimage}
/>
`Enable Wall Height for Scene` in
...
### Enable Tooltip
<Image
  src='/../public/images/Wall-Height/Wall_Height_Tooltip.png'
  alt='The wall height tooltip'
  width={2000}
  height={2000}
  className={styles.wikiimage}
/>
The tooltip will display when a wall is
hovered, showing its lowest and highest elevation.

### Display Height on Walls
<Image
  src='/../public/images/Wall-Height/Wall_Height_Display_Value.png'
