...
<ImageButBetter  src='/../public/images/Smart-Target/Stpips.png'  alt='Alternate Targeting Indicators'  width={2000}  height={2000}  className={styles.wikiimagesmall}/>
# Smart Target
...
3. Target all tokens in a template by `Alt + Click`ing the template (shift
